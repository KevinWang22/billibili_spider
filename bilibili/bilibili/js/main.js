...
// 导入抠出来的js文件
// require写的是文件路径
var decrypt = require('./dm_decrypt')
...
app.post('/decrypt', function (req, res){
    ...
    let encryptDataDict = req.body
    let encryptData = encryptDataDict.encrypt_data

    // 调用解析函数
    let decryptData = decrypt.dataDecodeMain(encryptData)
