...
DANMU_URL = 'https://api.bilibili.com/x/v2/dm/web/seg.so?type=1&oid={oid}&pid={pid}&segment_index=1'
DETAIL_URL = 'https://api.bilibili.com/x/web-interface/view/detail?bvid={bvid}&aid={aid}' \
             '&need_operation_card=1&web_rm_repeat=&need_elec=1&out_referer='
EP_INFO_URL = 'https://api.bilibili.com/pgc/season/episode/web/info?ep_id={ep_id}'
DECRYPT_URL = 'http://localhost:2229/decrypt'
...
DOWNLOADER_MIDDLEWARES = {
    ...
    'bilibili.middlewares.MyRetryMiddleware': 545,
...
ITEM_PIPELINES = {
    ...
    'bilibili.pipelines.DanmakuPipeline': None,
}
...
REDIS_PORT = 6379
REDIS_DANMAKU_KEY = 'danmu:start_urls'
# proxy pool key, 'http_proxies' for http, 'https_proxies' for https
REDIS_PROXY_KEY = 'https_proxies'
